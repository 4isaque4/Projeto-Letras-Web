...
Carregado automaticamente por todo agente Claude Code neste repositório. Consolida conceitos de produto, arquitetura e processo que **não podem ser inferidos apenas lendo o código**. Leia antes de sugerir código, copy de UI, nomes de entidade ou exemplos.
