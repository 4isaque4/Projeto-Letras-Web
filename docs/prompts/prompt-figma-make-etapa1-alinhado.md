...
- Fonte de verdade funcional: regras de negocio em `docs/insumos/regras-negocio/Regras de Negócio - Alfabetizador On-line.docx.zip` (RN001+).
...
- `docs/insumos/regras-negocio/Regras de Negócio - Alfabetizador On-line.docx.zip`
