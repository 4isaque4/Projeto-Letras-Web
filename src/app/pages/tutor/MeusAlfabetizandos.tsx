...
export default function MeusAlfabetizandos() {
  ...
  const meusAlunos = [
    ...
    { id: 2, nome: "Ana Oliveira", grupo: "Turma C", etapa: "Etapa 2", progresso: 38, status: "travado", ultimaAtividade: "2 dias atrás" },
    { id: 3, nome: "Carlos Mendes", grupo: "Turma B", etapa: "Etapa 1", progresso: 55, status: "ativo", ultimaAtividade: "Hoje, 09:15" },
    { id: 4, nome: "Beatriz Lima", grupo: "Turma A", etapa: "Etapa 2", progresso: 70, status: "ativo", ultimaAtividade: "Hoje, 11:45" },
    { id: 5, nome: "Pedro Costa", grupo: "Turma A", etapa: "Etapa 3", progresso: 85, status: "ativo", ultimaAtividade: "Hoje, 14:20" },
    { id: 6, nome: "Mariana Costa", grupo: "Turma C", etapa: "Etapa 1", progresso: 42, status: "inativo", ultimaAtividade: "7 dias atrás" },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-gray-600 mt-1">Lista dos alunos vinculados a você</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="border border-gray-300 bg-white p-4">
          <p className="text-xs text-gray-500 mb-1">Ativos Hoje</p>
        ...
        <div className="border border-gray-300 bg-white p-4">
          <p className="text-xs text-gray-500 mb-1">Taxa Média de Progresso</p>
      ...
      <div className="border border-gray-300 bg-white">
        ...
        <div className="px-4 py-3 border-t border-gray-300 flex items-center justify-between">
          <p className="text-xs text-gray-600">Mostrando 1-6 de 12 registros</p>
